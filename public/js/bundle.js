...
exports.login = login; //Because function is async
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ2FqZXRvIiwiYSI6ImNrcHB4NzNyMzA2c3IzMHA3ZWU4cXhmcnEifQ.2rvFQvQKX1DwAB8SsROPtg';
  ...
  locations.forEach(function (loc) {
    console.log(loc.day); //Create marker
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); //Add popup info

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extend map bounds to fit locations
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51J1c9cAXBuOiaGoX19lkYqfjU9U9wGhVEmHZ0FeMwyL6TjKsXhftW7JEVjxrpyPU85WOGZcUQWVZ1BGy1oS9wHvQ00OevbC95w');
            _context.prev = 1;
            _context.next = 4;
